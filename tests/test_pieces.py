...
class TestPieces(unittest.TestCase):
    ...
    def test_blackpawn_valid_move_capture(self):
        pawn = pieces.Pawn('black', 3, 1)

        rival1 = pieces.Pawn('white', 4, 2)     # down_right
        rival2 = pieces.Pawn('white', 4, 0)     # down_left
    ...
    def test_blackpawn_invalid_move_capture(self):
        ...
        rival1 = pieces.Pawn('white', 2, 1)     # up
        rival2 = pieces.Pawn('white', 2, 2)     # up_right
        rival3 = pieces.Pawn('white', 3, 2)     # right
        rival4 = pieces.Pawn('white', 2, 1)     # down
        rival5 = pieces.Pawn('white', 3, 0)     # left
        rival6 = pieces.Pawn('white', 2, 0)     # up_left
    ...
    def test_whitepawn_valid_move_capture(self):
        ...
        rival1 = pieces.Pawn('black', 11, 2)    # up_right
        rival2 = pieces.Pawn('black', 11, 0)    # up_left
    ...
    def test_whitepawn_invalid_move_capture(self):
        ...
        rival1 = pieces.Pawn('black', 13, 1)     # up
        rival2 = pieces.Pawn('black', 12, 2)     # right
        rival3 = pieces.Pawn('black', 13, 2)     # down_right
        rival4 = pieces.Pawn('black', 13, 1)     # down
        rival5 = pieces.Pawn('black', 13, 0)     # down_left
        rival6 = pieces.Pawn('black', 12, 0)     # left
    ...
    def test_blackhorse_valid_move_capture(self):
        horse = pieces.Horse('black', 8, 8)

        rival1 = pieces.Pawn('white', 6, 9)     # up_right
        rival2 = pieces.Pawn('white', 10, 9)    # down_right
        rival3 = pieces.Pawn('white', 10, 7)    # down_left
        rival4 = pieces.Pawn('white', 6, 7)     # up_left
    ...
    def test_blackhorse_invalid_move_capture(self):
        ...
        rival1 = pieces.Pawn('white', 7, 8)     # up
        rival2 = pieces.Pawn('white', 8, 9)     # right
        rival3 = pieces.Pawn('white', 9, 8)     # down
        rival4 = pieces.Pawn('white', 8, 7)     # left
    ...
    def test_whitehorse_valid_move_capture(self):
        horse = pieces.Horse('white', 8, 8)

        rival1 = pieces.Pawn('black', 6, 9)     # up_right
        rival2 = pieces.Pawn('black', 10, 9)    # down_right
        rival3 = pieces.Pawn('black', 10, 7)    # down_left
        rival4 = pieces.Pawn('black', 6, 7)     # up_left
    ...
    def test_whitehorse_invalid_move_capture(self):
        ...
        rival1 = pieces.Pawn('black', 7, 8)     # up
        rival2 = pieces.Pawn('black', 8, 9)     # right
        rival3 = pieces.Pawn('black', 9, 8)     # down
        rival4 = pieces.Pawn('black', 8, 7)     # left
    ...
    def test_blackbishop_valid_move_capture(self):
        bishop = pieces.Bishop('black', 7, 7)

        rival1 = pieces.Pawn('white', 3, 3)     # up_left
        rival2 = pieces.Pawn('white', 5, 9)     # up_right
        rival3 = pieces.Pawn('white', 11, 11)   # down_right
        rival4 = pieces.Pawn('white', 8, 6)     # down_left
    ...
    def test_blackbishop_invalid_move_capture(self):
        ...
        rival1 = pieces.Pawn('white', 6, 7)     # up
        rival2 = pieces.Pawn('white', 7, 9)     # right
        rival3 = pieces.Pawn('white', 11, 7)    # down
        rival4 = pieces.Pawn('white', 7, 1)     # left
    ...
    def test_whitebishop_valid_move_capture(self):
        bishop = pieces.Bishop('white', 7, 7)

        rival1 = pieces.Pawn('black', 3, 3)     # up_left
        rival2 = pieces.Pawn('black', 5, 9)     # up_right
        rival3 = pieces.Pawn('black', 11, 11)   # down_right
        rival4 = pieces.Pawn('black', 8, 6)     # down_left
    ...
    def test_whitebishop_invalid_move_capture(self):
        ...
        rival1 = pieces.Pawn('black', 6, 7)     # up
        rival2 = pieces.Pawn('black', 7, 9)     # right
        rival3 = pieces.Pawn('black', 11, 7)   # down
        rival4 = pieces.Pawn('black', 7, 1)     # left
    ...
    def test_blackrook_valid_move_capture(self):
        rook = pieces.Rook('black', 7, 7)

        rival1 = pieces.Pawn('white', 0, 7)     # up
        rival2 = pieces.Pawn('white', 7, 5)     # right
        rival3 = pieces.Pawn('white', 12, 7)    # down
        rival4 = pieces.Pawn('white', 7, 1)     # left
    ...
    def test_blackrook_invalid_move_capture(self):
        ...
        rival1 = pieces.Pawn('white', 5, 5)     # up_rigth
        rival2 = pieces.Pawn('white', 9, 9)     # down_right
        rival3 = pieces.Pawn('white', 9, 5)     # down_left
        rival4 = pieces.Pawn('white', 3, 3)     # up_left
    ...
    def test_whiterook_valid_move_capture(self):
        rook = pieces.Rook('white', 7, 7)

        rival1 = pieces.Pawn('black', 0, 7)     # up
        rival2 = pieces.Pawn('black', 7, 5)     # right
        rival3 = pieces.Pawn('black', 12, 7)     # down
        rival4 = pieces.Pawn('black', 7, 1)     # left
    ...
    def test_whiterook_invalid_move_capture(self):
        ...
        rival1 = pieces.Pawn('black', 5, 5)     # up_rigth
        rival2 = pieces.Pawn('black', 9, 9)     # down_right
        rival3 = pieces.Pawn('black', 9, 5)     # down_left
        rival4 = pieces.Pawn('black', 3, 3)     # up_left
    ...
    def test_blackqueen_valid_move_capture(self):
        ...
        rival1 = pieces.Pawn('white', 1, 8)     # up
        rival2 = pieces.Pawn('white', 5, 11)    # up_right
        rival3 = pieces.Pawn('white', 8, 15)    # right
        rival4 = pieces.Pawn('white', 11, 11)   # down_right
        rival5 = pieces.Pawn('white', 12, 8)    # down
        rival6 = pieces.Pawn('white', 10, 6)    # down_left
        rival7 = pieces.Pawn('white', 8, 3)     # left
        rival8 = pieces.Pawn('white', 5, 5)     # up_left
    ...
    def test_whitekqueen_valid_move_capture(self):
        queen = pieces.Queen('white', 8, 8)

        rival1 = pieces.Pawn('black', 1, 8)     # up
        rival2 = pieces.Pawn('black', 5, 11)    # up_right
        rival3 = pieces.Pawn('black', 8, 15)    # right
        rival4 = pieces.Pawn('black', 11, 11)   # down_right
        rival5 = pieces.Pawn('black', 12, 8)    # down
        rival6 = pieces.Pawn('black', 10, 6)    # down_left
        rival7 = pieces.Pawn('black', 8, 3)     # left
        rival8 = pieces.Pawn('black', 5, 5)     # up_left
    ...
    def test_blackking_valid_move_capture(self):
        king = pieces.King('black', 8, 8)

        rival1 = pieces.Pawn('white', 7, 8)     # up
        rival2 = pieces.Pawn('white', 7, 9)     # up_right
        rival3 = pieces.Pawn('white', 8, 9)     # right
        rival4 = pieces.Pawn('white', 9, 9)     # down_right
        rival5 = pieces.Pawn('white', 9, 8)    # down
        rival6 = pieces.Pawn('white', 9, 6)    # down_left
        rival7 = pieces.Pawn('white', 8, 6)     # left
        rival8 = pieces.Pawn('white', 7, 6)     # up_left
    ...
    def test_whitekking_valid_move_capture(self):
        king = pieces.King('white', 8, 8)

        rival1 = pieces.Pawn('black', 7, 8)     # up
        rival2 = pieces.Pawn('black', 7, 9)     # up_right
        rival3 = pieces.Pawn('black', 8, 9)     # right
        rival4 = pieces.Pawn('black', 9, 9)     # down_right
        rival5 = pieces.Pawn('black', 9, 8)    # down
        rival6 = pieces.Pawn('black', 9, 6)    # down_left
        rival7 = pieces.Pawn('black', 8, 6)     # left
        rival8 = pieces.Pawn('black', 7, 6)     # up_left
